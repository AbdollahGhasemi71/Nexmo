...
@section('content')
 ...
 pelase your enter alt',]) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('webTitle','webTitle',['style'=>'font-weight:bold']) !!}
                        {!! Form::text('webTitle',old('webTitle'),['class'=>'form-control','placeholder'=>'
 pelase your enter webTitle',]) !!}
                        @error('webTitle')
                        <span class="text-danger text-left font-weight-bold mt-2">{{$message}}</span>
                        @enderror
                    </div>
 ...
 pelase your enter author']) !!}
                        <p class="text-left mt-3"><img src="{{asset('images/product/'.$product->image)}}" width="60"
                                                       height="60"></p>
                        @error('image')
                        <span class="text-danger text-left font-weight-bold mt-2">{{$message}}</span>
                        @enderror
 ...
 pelase your enter description',]) !!}
                    ...
                    <a href="{{route('product.index')}}" class="btn btn-info">go to panel index</a>
                </div>
            </div>
        </div>
    </div>
